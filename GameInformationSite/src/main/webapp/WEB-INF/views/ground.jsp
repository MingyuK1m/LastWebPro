	...
	<div class="container">
		...
		<div class="sidebar">
			<div style="margin-top: 50px">
				<form method="post">
					<table border="1" width="200" height="120">
						<tr bgcolor="black">
							<td align="center"><font size=3 color="white">아이디</font></td>
							<td><input type="text" name="id" id = "id" size="10">
							</td>
						</tr>
						<tr bgcolor="black">
							<td align="center"><font size=3 color="white">비밀번호</font></td>
						...
						<tr>
							...
							<input type="submit"
								...
								onclick="location='membership'"></td>
						</tr>
					</table>
				</form>
